...
* You should not record any copyrighted content. Our videos will always be freely available and provided under CC BY license.
* You should not record any content that may be considered offensive or inappropriate. Please avoid showing any kind of offensive or inappropriate content on your screen. If you are not sure about what is considered offensive or inappropriate, please contact the RISC OS Community team. Also please consider reading our [Code of Conduct](CODE_OF_CONDUCT.md).
...
* Please ensure that your video remains focused on the technical content and refrains from featuring any political, religious, or potentially illegal or offensive material. This includes any content that could be discriminatory or harmful to LGBT+ individuals and other minority groups or ethnicity. If you are unsure about what may be considered inappropriate, please consult the RISC OS Community team. Additionally, we strongly encourage you to familiarize yourself with our [Code of Conduct](CODE_OF_CONDUCT.md) for more detailed guidance.
* Please also understand that we will not publish any video containing that doesn't meet the above guidelines and doesn't respect our [Code of Conduct](CODE_OF_CONDUCT.md).
